    ...
    <div>
      ...
      <Card
        ...
        style={{
          width: "35rem",
          minWidth: "35rem",
          backgroundColor: "#da4518ff",
        }}
      >
        <h5 className="m-3">Calculadora Peso y Masa</h5>
        ...
        <Card>
          <Row>
            ...
            <Col sm={2} md={2}>
              ...
              >
                <Dropdown.Header>Selección de modo</Dropdown.Header>
                <Dropdown.Divider />
                <Dropdown.Item eventKey="1">Científica</Dropdown.Item>
                <Dropdown.Item eventKey="2">Divisas</Dropdown.Item>
                <Dropdown.Item eventKey="3">Peso y Masa</Dropdown.Item>
                <Dropdown.Item eventKey="4">Longitud</Dropdown.Item>
              </DropdownButton>
            </Col>
          </Row>
...
export default CalculadoraPesoMasa;
